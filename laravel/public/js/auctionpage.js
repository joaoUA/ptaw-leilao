...
var bidInputField = document.getElementById('bid-input-field');
btnBid === null || btnBid === void 0 ? void 0 : btnBid.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var auctionId, auctionItemId, userId, bid, response, data, errorMessage, successMessage;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        auctionId = btnBid.getAttribute('data-auction-id');
        auctionItemId = btnBid.getAttribute('data-auction-item-id');
        userId = btnBid.getAttribute('data-user-id');
        bid = bidInputField.value;
        if (!(bid == '')) {
          _context.next = 6;
          break;
        }
      ...
      case 14:
        ...
        throw new Error("".concat(response.status, ": ").concat(errorMessage));
      case 18:
